...
#define IOWR_ALTERA_AVALON_PIO_SET_BITS(addr, bits)     (GPIO_DOUT_SET = (bits))
#define IOWR_ALTERA_AVALON_PIO_CLEAR_BITS(addr, bits)   (GPIO_DOUT_CLR = (bits))
#define IORD_ALTERA_AVALON_PIO_DATA(addr)               (GPIO_DIN)
